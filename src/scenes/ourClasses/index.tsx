      ...
      >
          ...
          >
              <div className="md:w-3/5">
                ...
                <p className="py-5">
                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Magna fringilla urna porttitor rhoncus. Semper feugiat nibh sed pulvinar proin gravida hendrerit. Metus dictum at tempor commodo. Tempus imperdiet nulla malesuada pellentesque. 
                </p>
              </div>
          </motion.div>
